...
Message: ${message}
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <AnimatePresence>
        {showMenu && (
          <motion.div
            ...
            className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center md:hidden"
      ...
      <motion.section
        id="home"
        className="relative flex flex-col items-center justify-center min-h-[calc(100vh-64px)] bg-gradient-to-br from-[#F5A623] to-[#87CEEB] text-gray-800 p-8 pt-24"
      ...
      >
        <motion.div className="absolute inset-0 opacity-60">
          <Image
            src="/images/qatar-background.jpg"
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#1F2526]/70 via-transparent to-[#1F2526]/50"></div>
        </motion.div>

        <motion.div className="relative z-10 text-center max-w-4xl" variants={containerVariants}>
          <motion.div
            className="inline-flex items-center bg-[#1F2526] bg-opacity-80 text-white text-sm sm:text-base px-5 py-2 rounded-full mb-6 shadow-lg tracking-wide"
            variants={itemVariants}
            style={{
              background: 'linear-gradient(to right, #1F2526, #2B2F31)',
            }}
          >
          ...
          <motion.h1
            ...
            variants={itemVariants}
            style={{
              background: 'linear-gradient(to right, #16A34A, #000)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
            }}
          >
        ...
        <div className="max-w-7xl mx-auto text-center space-y-16">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-r from-blue-600 via-purple-700 to-pink-600 rounded-xl p-10 md:p-16 shadow-lg w-full mb-16"
            >
              <h2 className="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight drop-shadow-lg max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="flex flex-col md:flex-row items-center md:items-center gap-3 md:gap-5 mb-6 text-center md:text-left">
                  <div className="bg-green-700 text-white p-4 rounded-xl shadow-lg flex items-center justify-center w-14 h-14 mx-auto md:mx-0">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-3 pl-3">
